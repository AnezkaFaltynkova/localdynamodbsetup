...
public class StydyTimeCreateTable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String tableName = "Studytime";

        try {
            System.out.println("Attempting to create table; please wait...");
            Table table = dynamoDB.createTable(tableName,
                    Arrays.asList(new KeySchemaElement("deckId", KeyType.HASH),
                            new KeySchemaElement("date", KeyType.RANGE)),
                    Arrays.asList(new AttributeDefinition("deckId", ScalarAttributeType.N),
